...
public class BaseObject {
    public BaseObject() { }
    public BaseObject(nint pointer) => Pointer = pointer;
    ~BaseObject() {
        if (Allocated) Marshal.FreeHGlobal(Pointer);
    }
    ...
    public T As<T>() where T : BaseObject, new() {
        var newObj = (T)Activator.CreateInstance(typeof(T), Pointer);

        return newObj;
    }

    // public static implicit operator bool(BaseObject obj) => obj.Pointer != nint.Zero;
}
...
public unsafe partial class UObject : BaseObject {
    ...
    public static void InitSDK(nint gNames, nint gObjects) {
        GObjects = new PointerTArray<UObject>(gObjects);
        GNames = new PointerTArray<FNameEntry>(gNames);
    }
    ...
    public static UObject FindObjectByFullName(string fullName) {
    ...
    public static UClass FindClass(string fullName) {
        return FindObjectByFullName(fullName)?.As<UClass>();
    }

    public static UFunction FindFunction(string fullName) {
        return FindObjectByFullName(fullName)?.As<UFunction>();
    }

    public static T FindFirstInstanceOf<T>() where T : UObject, new() {
        foreach (var uObject in GObjects) {
            if (uObject == null) continue;
    ...
    public static T FindLastInstanceOf<T>() where T : UObject, new() {
        T returnValue = null;
    ...
    public static List<T> FindAllInstancesOf<T>() where T : UObject, new() {
    ...
    public static T FindDefaultObjectOf<T>() where T : UObject, new() {
        foreach (var uObject in GObjects) {
            if (uObject == null) continue;

            if (uObject.GetName().StartsWith("Default__") && uObject.IsA<T>()) {
                return uObject.As<T>();
            }
        }
    ...
    public bool IsA(UClass @class) {
        for (var superClass = Class; superClass != null; superClass = superClass.SuperField?.As<UClass>()) {
            if (superClass.Pointer == @class.Pointer) return true;
        }

        return false;
    }

    public nint GetVTableFunction(int index) {
        var vTable = (nint*)VfTableObject;
        return vTable[index];
    }

    public static nint ProcessEventPointer { get; set; }
    public void ProcessEvent(UFunction func, void* @params, nint unusedResult = 1) {
        ((delegate* unmanaged<nint, nint, void*, nint, void>)ProcessEventPointer)(Pointer, func.Pointer, @params, unusedResult);
    }
}

public unsafe partial class UFunction : UStruct {
    public ulong FunctionFlags {
        get => *(ulong*)(Pointer + 304);
        set => *(ulong*)(Pointer + 304) = value;
    }

    public ushort iNative {
        get => *(ushort*)(Pointer + 312);
        set => *(ushort*)(Pointer + 312) = value;
    }

    public nint Func {
        get => *(nint*)(Pointer + 344);
        set => *(nint*)(Pointer + 344) = value;
    }
}

public unsafe partial class UPackage {
    ...
    public FGuid Guid {
        get => new(Pointer + 128);
        set => Buffer.MemoryCopy((void*)value.Pointer, (void*)(Pointer + 128), 16, 16);
    }

    public PointerTArray<UObject> NetObjects {
        get => new(Pointer + 152);
        set => Buffer.MemoryCopy((void*)value.Pointer, (void*)(Pointer + 152), 16, 16);
    }
    ...
    public UnmanagedTArray<int> GenerationNetObjectCount {
        get => new(Pointer + 176);
        set => Buffer.MemoryCopy((void*)value.Pointer, (void*)(Pointer + 176), 16, 16);
    }
}

public unsafe class TArrayBase<T> : BaseObject, IEnumerable<T> {
    public TArrayBase() { }
    public TArrayBase(nint pointer, int elementSize) : base(pointer) {
...
public unsafe class UnmanagedTArray<T> : TArrayBase<T> where T : unmanaged {
    public UnmanagedTArray() { }
    public UnmanagedTArray(nint pointer) : base(pointer, sizeof(T)) { }

    public override T this[int index] {
        get {
            if (index > Count) throw new IndexOutOfRangeException($"Index was bigger than array size {Count}");

            return *(T*)((*(nint*)Pointer) + (index * ElementSize));
        }
        set {
            if (index > Count) throw new IndexOutOfRangeException($"Index was bigger than array size {Count}");

            *(T*)((*(nint*)Pointer) + (index * ElementSize)) = value;
        }
    }
}

public unsafe class StructTArray<T> : TArrayBase<T> where T : BaseObject, new() {
    public StructTArray() { }
    public StructTArray(nint pointer, int elementSize) : base(pointer, elementSize) { }

    public override T this[int index] {
        get {
            if (index > Count) throw new IndexOutOfRangeException($"Index was bigger than array size {Count}");

            var pointer = (*(nint*)Pointer) + (index * ElementSize);
        ...
        set {
            ...
            Buffer.MemoryCopy((void*)value.Pointer, (void*)((*(nint*)Pointer) + (index * ElementSize)), ElementSize, ElementSize);
        }
    }
}

public unsafe class PointerTArray<T> : TArrayBase<T> where T : BaseObject, new() {
    public PointerTArray() { }
    public PointerTArray(nint pointer) : base(pointer, nint.Size) { }

    public override T this[int index] {
        get {
            if (index > Count) throw new IndexOutOfRangeException($"Index was bigger than array size {Count}");

            var pointer = *(nint*)((*(nint*)Pointer) + (index * ElementSize));

            return pointer != nint.Zero ? (T)Activator.CreateInstance(typeof(T), pointer) : null;
        }
        set {
            if (index > Count) throw new IndexOutOfRangeException($"Index was bigger than array size {Count}");

            **(nint**)((*(nint*)Pointer) + (index * ElementSize)) = value.Pointer;
        }
    }
}

public unsafe class FString : UnmanagedTArray<char> {
    public FString() : base() { }
    public FString(nint pointer) : base(pointer) { }
    public FString(string str) {
        ...
        Max = Count = (str.Length * 2) + 2;
    }

    public override string ToString() => new(*(char**)Pointer, 0, Count);
}

public unsafe class FName : BaseObject {
    public FName() { }
    public FName(nint pointer) : base(pointer) { }

    public int Index => *(int*)Pointer;

    public int Number => *(int*)(Pointer + 4);

    public override string ToString() {
        var name = UObject.GNames[Index].Name;
        var number = Number;
...
public unsafe class FNameEntry : BaseObject {
    public FNameEntry() { }
    public FNameEntry(nint pointer) : base(pointer) { }

    public ulong Flags => *(ulong*)Pointer;

    public int Index => *(int*)(Pointer + 8);

    public unsafe string Name => new((char*)(Pointer + 24));

    public override string ToString() => Name;
}

public unsafe class FScriptDelegate : BaseObject {
    public FScriptDelegate() { }
    public FScriptDelegate(nint pointer) : base(pointer) { }
    ...
    public FName Name {
        get => new(Pointer + 8);
        set => Buffer.MemoryCopy((void*)value.Pointer, (void*)(Pointer + 8), 8, 8);
    }
}

public unsafe class TInterface<T> : BaseObject where T : BaseObject, new() {
    public TInterface() { }
    public TInterface(nint pointer) : base(pointer) { }

    public T Interface {
        get {
            var pointer = *(nint*)Pointer;
            return pointer == nint.Zero ? null : new() {
                Pointer = pointer
            };
        }
        set => *(nint*)Pointer = value.Pointer;
...
public unsafe class FixedArrayBase<T> : BaseObject, IEnumerable<T> {
    public FixedArrayBase() { }
    public FixedArrayBase(nint pointer, int elementSize, int arraySize) : base(pointer) {
        ElementSize = elementSize;
        Size = arraySize;
    }
...
public unsafe class UnmanagedFixedArray<T> : FixedArrayBase<T> where T : unmanaged {
    public UnmanagedFixedArray() { }
    public UnmanagedFixedArray(nint pointer, int size) : base(pointer, sizeof(T), size) { }

    public override T this[int index] {
        get {
            if (index > Size) throw new IndexOutOfRangeException($"Index was bigger than the fixed array size {Size}");

            return *(T*)(Pointer + (index * ElementSize));
        }
        set {
            if (index > Size) throw new IndexOutOfRangeException($"Index was bigger than the fixed array size {Size}");

            *(T*)(Pointer + (index * ElementSize)) = value;
        }
    }
}

public unsafe class StructFixedArray<T> : FixedArrayBase<T> where T : BaseObject, new() {
    public StructFixedArray() { }
    public StructFixedArray(nint pointer, int elementSize, int arraySize) : base(pointer, elementSize, arraySize) { }

    public override T this[int index] {
        get {
            if (index > Size) throw new IndexOutOfRangeException($"Index was bigger than the fixed array size {Size}");

            var pointer = Pointer + (index * ElementSize);
        ...
        set {
            ...
            *(nint*)(Pointer + (index * ElementSize)) = value.Pointer;
        }
    }
}

public unsafe class PointerFixedArray<T> : FixedArrayBase<T> where T : BaseObject, new() {
    public PointerFixedArray() { }
    public PointerFixedArray(nint pointer, int size) : base(pointer, nint.Size, size) { }

    public override T this[int index] {
        get {
            if (index > Size) throw new IndexOutOfRangeException($"Index was bigger than the fixed array size {Size}");

            var pointer = *(nint*)(Pointer + (index * 8));
        ...
        set {
            ...
            **(nint**)(Pointer + (index * 8)) = value.Pointer;
        }
    }
}

public unsafe class FFrame : BaseObject {
    public FFrame() { }
    public FFrame(nint pointer) : base(pointer) { }
